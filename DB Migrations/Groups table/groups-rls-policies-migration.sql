...
-- This migration should be run AFTER both groups and user_group_mapping tables are created
...
-- RLS is enabled on the table (in groups-table-migration.sql) but no policies
